        ...
        <div className='background-img'>
            <div className='overlay'>
                <div className=' absolute top-[40%] left-[35%] 2xl:left-[40%]'>
                    <h2 className='text-4xl font-bold text-gray-200 mb-4 text-center'>Audio Combine</h2>
                    <p className='text-lg mb-6 text-center'>Use the audio merger to quickly edit your music</p>
                    {/* Open the modal using ID.showModal() method */}
                    <div className='flex flex-col justify-center items-center'>
                        {
                            user?.email ? <><button className="font-semibold border-solid border-2 border-blue-400 p-2 rounded-lg hover:border-red-200 hover:bg-[#1C1E25] hover:text-blue-400 bg-blue-200 text-black px-4 shadow-lg shadow-cyan-500/50" onClick={()=>window.my_modal_1.showModal()}>Log Out</button></> : <button className="font-semibold border-solid border-2 border-blue-400 p-2 rounded-lg hover:border-red-200 hover:bg-[#1C1E25] hover:text-blue-400 bg-blue-200 text-black px-4 shadow-lg shadow-cyan-500/50" onClick={()=>window.my_modal_1.showModal()}>Log In</button>                        }
                    </div>
